...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    public fun getfirebasemessage ( context: Context, title:String, msg:String ){




        val notificationBuilder =NotificationCompat.Builder(this,"notification").setSmallIcon(R.drawable.logo)
